...
7. Зарегистрируемся на http://heroku.com и создадим там приложение с любым именем, которое потом будет отображаться в url.

8. Перейдём во вкладку Resources и добавим Add-on: Heroku Postgres.
...
9. Зарегистрируемся на http://hub.docker.com и создадим там свой репозиторий для докер образов.

10. Перейдём на сайте в настройки нашего репозитория https://app.travis-ci.com во вкладку "Settings". 
...
11. Ссылка на развернутое приложение на платформе Heroku:
